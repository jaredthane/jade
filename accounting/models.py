...
#	parent = ForeignKey(Account, blank=True, default=None)
...
class	Entry(DirtyMixin, Model):	
	...
	balance = DecimalField(max_digits=5, decimal_places=2, default=None)
...
#			#print "detected change of date"
	...
	class Meta:
		...
		ordering = ('date',)		
	def __unicode__(self):
		return self.get_modifier_display() +" " +  self.account.display + " $" + str(self.value) + " balance-> "+str(self.balance)
