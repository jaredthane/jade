class InitialSchema < ActiveRecord::Migration
  ...
  #
    ...
    create_table "production_lines", :force => true do |t|
  ...
  def self.down
    ...
    drop_table :payments
    drop_table :people
    drop_table :physical_count_lines
    drop_table :physical_counts
    drop_table :post_types
    drop_table :posts
    drop_table :preferences
    drop_table :price_group_names
