...
from jade.entities.models import Vendor, Site
...
class Inventory(Model):
	...
	default_sales_warranty = ForeignKey(WarrantyPolicy, related_name='sales_warranty_id', blank=True)
	default_purchase_warranty = ForeignKey(WarrantyPolicy, related_name='purchase_warranty_id', blank=True)
