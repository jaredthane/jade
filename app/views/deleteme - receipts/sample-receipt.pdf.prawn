...
for copy in ['cliente', 'vendor', 'government'] do
	...
	pdf.bounding_box([0,y], :width=>pdf.bounds.width, :height=>(pdf.bounds.height)/3) do
		pdf.padded_box(25) do
			...
			pdf.bounding_box([pdf.bounds.left, pdf.bounds.top-20], :width=>pdf.bounds.width/3-40, :height=>85) do
				pdf.stroke_bounds
				pdf.font_size = 10
				if vendor.address != ''
			...
			pdf.line [pdf.bounds.width/3-40, pdf.bounds.top-35], [540, pdf.bounds.top-35]
			# Put the client information in the top-right corner
			pdf.text "Cliente:",:at=>[pdf.bounds.width/3-40, pdf.bounds.top-47]
			pdf.bounding_box([pdf.bounds.width/3, pdf.bounds.top-40], :width=>pdf.bounds.width/3, :height=>65, :overflow => :truncate) do
				pdf.stroke_bounds
				pdf.font_size = 12
			...
			# Put the client information in the top-right corner
			pdf.bounding_box([pdf.bounds.width/3*2, pdf.bounds.top-40], :width=>pdf.bounds.width/3, :height=>65) do
				pdf.stroke_bounds
				pdf.font_size = 10
